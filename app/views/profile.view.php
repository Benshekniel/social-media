      ...
      <div>
         <form action="" method="post" onsubmit="submit_post(event)">
            <div class="bg-secondary p-2">
               <textarea rows="4" id="post-input" class="form-control" placeholder="Whats on your mind?" name="post_content"></textarea>
               <label>
                  <i style="cursor:pointer;" class="h1 text-white bi bi-image"></i>
                  <input id="post-image-input" onchange="display_post_image(this.files[0]);" type="file" class="d-none" name="profile_image">
               </label>
               <button class="mt-1 btn btn-warning float-end">Post</button>
               <div class="text-center d-none">
                  <img class="post-image m-1" alt="profile" style="width: 100px; height:100px;object-fit:cover;">
               </div>
